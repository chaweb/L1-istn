...
public class Exe4 {
	...
	public static int[][] transposition(int[][] tab1) {
		int[][] tabR = new int[tab1[0].length][tab1.length];
	...
	public static int[][] rotation(int[][] tab1) {
		return symetrieHorizontale(transposition(tab1));
	}
    public static void main(String[] args) {
		...
		afficheTab2D(transposition(rectangle));
